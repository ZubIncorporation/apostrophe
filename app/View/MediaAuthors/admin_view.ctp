<div class="mediaAuthors view">
<h2><?php  echo __('Media Author'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($mediaAuthor['MediaAuthor']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($mediaAuthor['MediaAuthor']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Promotion'); ?></dt>
		<dd>
			<?php echo h($mediaAuthor['MediaAuthor']['promotion']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="related">
	...
	<?php if (!empty($mediaAuthor['Media'])): ?>
	...
	<?php
		$i = 0;
		foreach ($mediaAuthor['Media'] as $media): ?>
		<tr>
